// 파일 위치: Assets/_Project/Scripts/Core/Utilities/AwaitableHelper.cs
using UnityEngine;
using System;
...
{
    /// <summary>
    /// Unity 6.0 Awaitable 유틸리티 모음
    /// Coroutine 대신 Awaitable 사용을 위한 헬퍼 클래스
    /// </summary>
    public static class AwaitableHelper
    {
        // 이미 완료된 Awaitable을 위한 정적 캐시
