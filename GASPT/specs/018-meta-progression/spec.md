...
| ID | 요구사항 | 수락 기준 |
|----|----------|-----------|
| FR-020 | 스컬 해금 | Soul로 새 스컬 해금, 드롭 풀에 추가 |
...
| FR-032 | 수집 업적 | "스컬 5종 획득", "아이템 20종 획득" 등 |
...
| FR-041 | 해금 NPC | 스컬/아이템 해금 |
| FR-042 | 업적 게시판 | 업적 목록 및 보상 수령 |
| FR-043 | 던전 입구 | 새 런 시작 |
| FR-044 | 훈련장 | 해금된 스컬/스킬 테스트 (선택적) |
